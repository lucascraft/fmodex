...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.fmodex.core.ezaudio.Device} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Device_ID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Device_ID_feature", "_UI_Device_type"),
				 EzaudioPackage.Literals.DEVICE__ID,
				 true,
				 false,
				 false,
	...
	protected void addTrackPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Device_track_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Device_track_feature", "_UI_Device_type"),
				 EzaudioPackage.Literals.DEVICE__TRACK,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addChannelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Device_channel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Device_channel_feature", "_UI_Device_type"),
				 EzaudioPackage.Literals.DEVICE__CHANNEL,
				 true,
				 false,
				 true,
				 null,
