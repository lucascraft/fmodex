...
public abstract class AbstractDeviceWidget {
	protected AudioChannel gChannel;
	protected AudioSound gSound;
	...
	public abstract void refresh(AudioChannel aChannel, AudioSound gSound);
	
	public void init(AudioChannel gChannel, AudioSound gSound) {
		this.gChannel 	= gChannel;
		this.gSound 	= gSound;
		refresh(gChannel, gSound);
	}
